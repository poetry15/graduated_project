	...
	while True:
		...
		#   temperature=0.3,
			...
			messages=[
				{
					"role": "system",
					"content": "You will be provided with a block of text, and your task is to translate text to extract a list of keywords from it.擷取完關鍵字後，幫我計算關鍵字出現頻率 有相似詞或同種類的詞幫我合併並算在一起，以python字典的形式回傳.for example: input: ['夕陽西下，天空染上橘紅色的光輝，我感受到無比的寧靜與滿足。','看著夕陽緩緩地沉入地平線，那種美麗的景象讓我心中充滿了寧靜和滿足感。','當我漫步在滿是櫻花的公園裡，花瓣隨風飄落，我感到無限的喜悅與幸福。','每一步都伴隨著櫻花的芬芳，心中充滿了春天的活力和對未來的美好期待。','夜晚的星空閃爍，繁星點點，我感到一種深深的孤獨和思索。','抬頭仰望無邊的夜空，心中彷彿也變得無限遼闊，但同時也感受到那份孤獨感。','走進那間古老的書店，書香撲面而來，我感到一種莫名的懷舊與安慰。','看著一本本承載著歲月的書籍，彷彿回到了那個簡單而美好的過去，心中充滿了溫暖。','大雨傾盆而下，雨水打在窗戶上，我感到一種說不出的哀愁與釋放。','雨水模糊了視線，也模糊了心中的煩惱，讓我在雨聲中找到了片刻的釋放和解脫。'] output: {'夕陽': 2,'天空': 1,'橘紅色': 1,'光輝': 1,'寧靜': 2,'滿足': 2,'地平線': 1,'美麗': 1,'景象': 1,'心中': 2,'滿足感': 1,'櫻花': 2,'公園': 1,'花瓣': 1,'風飄落': 1,'喜悅': 1,'幸福': 1,'芬芳': 1,'春天': 1,'活力': 1,'未來': 1,'美好期待': 1,'星空': 1,'閃爍': 1,'繁星': 1,'孤獨': 2,'思索': 1,'夜空': 1,'無限遼闊': 1,'孤獨感': 1,'古老書店': 1,'書香': 1,'懷舊': 1,'安慰': 1,'書籍': 1,'歲月': 1,'簡單': 1,'美好': 1,'過去': 1,'溫暖': 1,'大雨': 1,'傾盆而下': 1,'窗戶': 1,'哀愁': 1,'釋放': 2,'視線': 1,'煩惱': 1,'雨聲': 1,'解脫': 1}",
				},
				{
					"role": "user",
